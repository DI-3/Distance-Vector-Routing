...
#description     :This script will download and install the starter template/module for assignment3.
...
if ask "Do you want to continue?" Y; then
	wget http://mocha.cse.buffalo.edu/cse-489_589/assignment3_package.sh
	chmod +x assignment3_package.sh

	wget http://mocha.cse.buffalo.edu/cse-489_589/assignment3_update.sh
	chmod +x assignment3_update.sh

	wget http://mocha.cse.buffalo.edu/cse-489_589/assignment3_tester.sh
	chmod +x assignment3_tester.sh

	wget http://mocha.cse.buffalo.edu/cse-489_589/assignment3_template_${lang_option}.tar
